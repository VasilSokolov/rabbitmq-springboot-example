...
//    public static final String ROUTING_KEY = "javatechie_routingKey";
    public static final String QUEUE = "rabbitMQ_demo_queue";
    public static final String EXCHANGE = "rabbitMQ_demo_exchange";
    public static final String ROUTING_KEY = "rabbitMQ_demo_routingKey";
